// Theme constants: единые цвета, отступы, радиусы и тени для всего интерфейса.
/**
...
export const COLORS = {
  ...
  gradients: {
    ...
    header: ['#4F46E5', '#7C3AED', '#C026D3'] as [string, string, string], // Matches intro page gradient
  },
};
