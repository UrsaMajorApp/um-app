...
export default function TeacherProfile() {
  ...
  const displayName =
    [user?.firstName, user?.lastName].filter(Boolean).join(" ") || "Учитель";
            ...
            <View style={styles.infoSection}>
              ...
              <View style={[styles.infoRow, { marginTop: 16 }]}>
                ...
                <View>
                  ...
                  <Text style={styles.infoRowVal}>
                    {user?.phone ? `${user.phone}@um.app` : "marat@um.app"}
                  </Text>
                </View>
              </View>
            </View>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.orgName}>
                    Образовательный центр "Робототехника"
                  </Text>
            ...
            <View style={styles.infoSection}>
              ...
              <View style={styles.statsGrid}>
                <View style={styles.statItem}>
                  <View
                    style={[styles.statIcon, { backgroundColor: "#F5F3FF" }]}
                  >
                ...
                <View style={styles.statItem}>
                  <View
                    style={[styles.statIcon, { backgroundColor: "#FFFBEB" }]}
                  >
