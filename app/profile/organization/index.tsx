        ...
        {!isVerified && !isPending && (
          ...
          >
            ...
            <Text style={styles.verificationSub}>
              Загрузите документы, чтобы получить статус проверенной организации
              и начать принимать оплаты.
            </Text>

            <View style={{ gap: 16 }}>
              <View>
                <Text
                  style={[styles.inputLabel, { color: "white", opacity: 0.9 }]}
                >
                ...
                <TextInput
                  value={bin}
                  onChangeText={(t) =>
                    setBin(t.replace(/[^\d]/g, "").slice(0, 12))
                  }
              ...
              >
                <View
                  style={[
                    styles.checkbox,
                    hasAcceptedOffer && styles.checkboxActive,
                  ]}
                >
                  {hasAcceptedOffer && (
        ...
        {isPending && (
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Text
                  style={{ fontSize: 16, fontWeight: "800", color: "#854D0E" }}
                >
