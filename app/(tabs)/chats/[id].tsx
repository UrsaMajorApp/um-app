// Экран chats/[id]: загружает и показывает чаты пользователя в кабинете пользователя.
            ...
            <SafeAreaView edges={['top']}>
              <View
                style={{
                  flexDirection: 'row',
                  alignItems: 'center',
                  paddingHorizontal: IS_DESKTOP ? LAYOUT.dashboardHorizontalPaddingDesktop : 20,
                  paddingTop: 12,
                  paddingBottom: 20,
                }}
              >
