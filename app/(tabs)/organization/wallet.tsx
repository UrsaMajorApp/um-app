        ...
        <FlatList
          ...
          ListHeaderComponent={
            <View style={{ marginBottom: 32, marginTop: 20 }}>
              {/* Balance Card */}
              <LinearGradient colors={['#6C5CE7', '#8B5CF6']} style={styles.balanceCard}>
                ...
                <View style={styles.breakdownBox}>
                  <View style={styles.breakdownRow}>
                    ...
                    <Text style={styles.breakdownVal}>{formatKZT(summary.totalRevenue)}</Text>
                  </View>
                  <View style={[styles.breakdownRow, { opacity: 0.6 }]}>
                    <View
                      style={[styles.breakdownDot, { backgroundColor: 'rgba(255,255,255,0.5)' }]}
                    />
                    <Text style={styles.breakdownLabel}>Комиссия UM (10%)</Text>
                    <Text style={styles.breakdownVal}>-{formatKZT(summary.commission)}</Text>
                  </View>
                </View>
              ...
              <View style={styles.statsRow}>
                <View style={styles.statBox}>
                  ...
                  <View>
                    <Text style={styles.statVal}>{formatKZT(summary.periodRevenue)}</Text>
