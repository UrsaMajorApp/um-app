...
export const SCORE_TO_SKILLS: Record<string, string[]> = {
  ...
  logic: ['Логика', 'Код', 'Математика', 'Крит. мышление'],
  creative: ['Креативность', 'Дизайн'],
  creativity: ['Креативность', 'Дизайн'],
  social: ['Команда', 'Коммуникация', 'Лидерство'],
  physical: ['Команда'],
  linguistic: ['Языки', 'Коммуникация'],
  R: ['Инженерия', 'Робототехника', 'Пространственное мышление'],
  I: ['Наука', 'Аналитика', 'Крит. мышление'],
  A: ['Креативность', 'Дизайн', 'Визуальное мышление'],
  S: ['Коммуникация', 'Команда', 'Лидерство'],
  E: ['Предпринимательство', 'Презентации', 'Лидерство'],
  C: ['Фокус', 'Внимательность', 'Математика'],
};
